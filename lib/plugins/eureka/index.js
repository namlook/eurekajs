...
var registerTasks = function registerTasks(plugin, options) {
    ...
    var tasks = {};
    _lodash2['default'].forOwn(options.serverConfig.tasks, function (taskConfig, taskName) {

        var taskHandler = undefined;
        ...
        var taskFn = function taskFn(job, done) {
    ...
    return {
        enqueue: function enqueue(taskName, data, done) {
