...
var routes = {
    ...
    find: {
        ...
        config: {
            validate: {
                query: {
                    ...
                    filter: _joi2['default'].object().pattern(/.+/, _joi2['default'].alternatives()['try'](_joi2['default'].string(), _joi2['default'].object())),
        ...
        handler: function handler(request, reply) {
            ...
            var queryFilter = _request$query.filter;
            var limit = _request$query.limit;
            var offset = _request$query.offset;
            var distinct = _request$query.distinct;
    ...
    count: {
        ...
        handler: function handler(request, reply) {
            var _request$query2 = request.query;
            var queryFilter = _request$query2.filter;
            var distinct = _request$query2.distinct;
    ...
    groupBy: {
        ...
        config: {
            validate: {
                query: {
                    operator: _joi2['default'].string()['default']('count'),
        ...
        handler: function handler(request, reply) {
            ...
            var property = request.params.property.split(',');

            var queryFilter = request.query.filter;

            var queryOptions = {};

            var _request$query3 = request.query;
            var operator = _request$query3.operator;
            var target = _request$query3.target;
            ...
            Model.groupBy(aggregator, queryFilter, queryOptions).then(function (data) {
    ...
    aggregate: {
        ...
        config: {
            validate: {
                query: {
                    field: _joi2['default'].object().pattern(/.+/, _joi2['default'].alternatives()['try'](_joi2['default'].string(), _joi2['default'].object().pattern(/^\$.+/, _joi2['default'].alternatives()['try'](_joi2['default'].boolean(), _joi2['default'].string())))),
                    // TODO remove
                    label: _joi2['default'].object().pattern(/.+/, _joi2['default'].alternatives()['try'](_joi2['default'].string(), _joi2['default'].object().pattern(/^\$.+/, _joi2['default'].alternatives()['try'](_joi2['default'].boolean(), _joi2['default'].string())))),
                    filter: _joi2['default'].object().pattern(/.+/, _joi2['default'].alternatives()['try'](_joi2['default'].string(), _joi2['default'].object())),
                    limit: _joi2['default'].number()['default'](100),
                    distinct: _joi2['default'].boolean()['default'](false),
                    sort: _joi2['default'].alternatives()['try'](_joi2['default'].array().items(_joi2['default'].string()), _joi2['default'].string())
                }
            }
        ...
        handler: function handler(request, reply) {
            var Model = request.Model;
            var db = request.db;
            var _request$query4 = request.query;
            var field = _request$query4.field;
            var label = _request$query4.label;
            var limit = _request$query4.limit;
            var distinct = _request$query4.distinct;
            var sort = _request$query4.sort;
            var filter = _request$query4.filter;
            ...
            db.aggregate(Model.name, field, filter, queryOptions).then(function (data) {
                return reply.jsonApi({ data: data });
            })['catch'](function (err) {
                if (err.name === 'ValidationError') {
                    return reply.badRequest(err.message, err.extra);
    ...
    stream: {
        ...
        handler: function handler(request, reply) {
            var _request$query5 = request.query;
            var queryFilter = _request$query5.filter;
            var limit = _request$query5.limit;
            var distinct = _request$query5.distinct;
            var sort = _request$query5.sort;
            var fields = _request$query5.fields;
            ...
            var apiBaseUri = request.apiBaseUri;
            var db = request.db;
            var _request$query6 = request.query;
            var delimiter = _request$query6.delimiter;
            var header = _request$query6.header;
