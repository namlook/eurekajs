    ...
    signUp: {
        ...
        handler: function handler(request, reply) {
            ...
            user.save().then(function (savedUser) {
                ...
                var token = _jsonwebtoken2['default'].sign({ email: payload.email, userId: userPojo._id }, secret, { expiresInMinutes: 180 });
    ...
    */
    ...
    sudo: {
        ...
        handler: function handler(request, reply) {
            ...
            var token = _jsonwebtoken2['default'].sign(credentials, secret, { expiresInMinutes: 60 });
            reply.ok({ token: token });
        }
    },
    ...
    */
    ...
    passwordRequest: {
        ...
        handler: function handler(request, reply) {
            ...
            user.save().then(function () {
                var token = _jsonwebtoken2['default'].sign({ email: email, token: resetToken }, secret, { expiresInMinutes: 180 });
