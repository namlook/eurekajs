        ...
        compose: function compose(callback) {
            ...
            _glue2['default'].compose(manifest, function (composeErr, server) {
                ...
                that.beforeRegister(server, function (beforeRegisterErr) {
                     ...
                     * register plugins
                     */
                    server.register([_inert2['default'], { register: _hapiMailer2['default'], options: config.mailer }, _hapiAuthBasic2['default'], _hapiAuthJwt2['default'], { register: _pluginsArchimedes2['default'], options: archimedesPluginConfig }, { register: _pluginsEureka2['default'], options: eurekaPluginConfig }], function (registerErr) {
                        if (registerErr) {
